...
public class TesteCriteria {
	...
	public static void main(String[] args) {
		...
		List<Produto> p = pDao.buscarPorParametroComCriteria(null, null, LocalDate.now());
		
		p.forEach(produto -> System.out.println(produto.getDescricao() + " " + produto.getDataCadastro()));
